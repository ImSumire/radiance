...
void reload(State* state) {
    ...
    void (*tmp_init)(State*) = (void (*)(State*))dlsym(dlib, "dlib_init");
    if (!tmp_init) {
    ...
    void (*tmp_drop)(State*) = (void (*)(State*))dlsym(dlib, "dlib_drop");
    if (!tmp_drop) {
    ...
    void (*tmp_update)(State*) = (void (*)(State*))dlsym(dlib, "dlib_update");
    if (!tmp_update) {
    ...
    void (*tmp_render)(State*) = (void (*)(State*))dlsym(dlib, "dlib_render");
    if (!tmp_render) {
